import{_ as e}from"./index.vue_vue_type_script_setup_true_lang-CEmQDEAv.js";import{d as t,i as o,e as s,o as r}from"./index-jH-amHpW.js";const l=`# vue-jenga是什么
...
+ 表单组件开发
  + ~~解决非props配置参数的接收~~
  + ~~upload子组件增加对instance的暴露~~ 
  + ~~解决rules不支持纯validator配置的问题，暴露source~~
  + ~~解决disabled参数问题~~
  + ~~表单配置列表二次运算合并全局函数回调~~
  + ~~实现GRID布局下的跨行跨列~~
  + ~~子组件方法的暴露~~ 
...
+ ~~表格组件VjTable~~
  ...
  + ~~文档~~
  + ~~表格组件增加注册单元格类型功能~~
+ ~~开发工具链搭建~~`,c=t({__name:"index",setup(i){return(p,u)=>{const n=e;return r(),o(n,{mdStr:s(l)},null,8,["mdStr"])}}});export{c as default};
