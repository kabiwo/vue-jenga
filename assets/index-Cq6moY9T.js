import{d as i,h as m,q as r,b as a,k as e,l as d,e as t,F as k,cw as p,o as c}from"./index-wjI9uMzd.js";import{_ as f}from"./index.vue_vue_type_script_setup_true_lang-Bmt5bp4N.js";import{l as u}from"./array-DIpJ5Tfm.js";const j=`# 组件介绍
...
可参看对应table组件展示实例  `,L='```html\n<vj-fold-link :links="links" :num="3">\n</vj-fold-link>\n```\n\n```ts\nconst links = ref(list(0, 20, i => {\n  return {\n    label: `link${i + 1}`,\n    func: () => alert(`link${i + 1}`)\n  };\n}));\n```',_={class:"vj-h-30"},v=i({__name:"index",setup(V){const o=m(u(0,20,n=>({label:`link${n+1}`,func:()=>alert(`link${n+1}`)})));return r(()=>{console.log(o)}),(n,b)=>{const l=f,s=p;return c(),a(k,null,[e(l,{mdStr:t(j)},null,8,["mdStr"]),d("div",_,[e(s,{links:o.value,num:3},null,8,["links"])]),e(l,{mdStr:t(L)},null,8,["mdStr"])],64)}}});export{v as default};
