...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    '/': RouteRecordInfo<'/', '/', Record<never, never>, Record<never, never>, '//' | '//form/' | '//menu/' | '//table/' | '//utils/conf/' | '//utils/confirm/' | '//utils/file/' | '//utils/generator/' | '//utils/init/' | '//utils/request/' | '//utils/resolver/' | '//utils/type/'>,
  ...
  export interface _RouteFileInfoMap {
    'src/views/index.vue': {
      routes: '/' | '//' | '//form/' | '//menu/' | '//table/' | '//utils/conf/' | '//utils/confirm/' | '//utils/file/' | '//utils/generator/' | '//utils/request/' | '//utils/init/' | '//utils/resolver/' | '//utils/type/' | '//utils/conf' | '//utils/confirm' | '//utils/file' | '//form' | '//utils/generator' | '//utils/init' | '//menu' | '//utils/request' | '//utils/resolver' | '//table' | '//utils/type' | '//utils'
      views: 'default'
    }
