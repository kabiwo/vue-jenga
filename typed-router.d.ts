...
declare module 'vue-router/auto-routes' {
  ...
  export interface _RouteFileInfoMap {
    'src/views/index.vue': {
      routes: '/' | '//' | '//table/' | '//form/' | '//form/custom/' | '//form/cascader/' | '//form/date/' | '//form/empty/' | '//form/input/' | '//form/repeat/' | '//form/select/' | '//form/sub/' | '//form/tree/' | '//form/upload/' | '//menu/' | '//modal/' | '//modal/form/' | '//utils/conf/' | '//utils/file/' | '//utils/confirm/' | '//utils/generator/' | '//utils/init/' | '//utils/request/' | '//utils/resolver/' | '//utils/type/' | '//form/cascader' | '//utils/conf' | '//utils/confirm' | '//form/custom' | '//form/date' | '//form/empty' | '//utils/file' | '//form' | '//modal/form' | '//utils/generator' | '//utils/init' | '//form/input' | '//menu' | '//modal' | '//form/repeat' | '//utils/request' | '//utils/resolver' | '//form/select' | '//form/sub' | '//table' | '//form/tree' | '//utils/type' | '//form/upload' | '//utils'
      views: 'default'
    }
