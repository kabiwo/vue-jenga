...
declare module 'vue-router/auto-routes' {
  ...
  export interface _RouteFileInfoMap {
    'src/views/index.vue': {
      routes: '/' | '//' | '//form/' | '//form/cascader/' | '//form/custom/' | '//form/date/' | '//form/empty/' | '//form/input/' | '//form/multi/' | '//form/repeat/' | '//form/select/' | '//form/sub/' | '//form/tree/' | '//form/upload/' | '//modal/' | '//modal/form/' | '//menu/' | '//table/' | '//other/fold-link/' | '//utils/conf/' | '//utils/confirm/' | '//utils/file/' | '//utils/generator/' | '//utils/request/' | '//utils/init/' | '//utils/resolver/' | '//utils/type/' | '//form/cascader' | '//utils/conf' | '//utils/confirm' | '//form/custom' | '//form/date' | '//form/empty' | '//utils/file' | '//other/fold-link' | '//form' | '//modal/form' | '//utils/generator' | '//utils/init' | '//form/input' | '//menu' | '//modal' | '//form/multi' | '//other' | '//form/repeat' | '//utils/request' | '//utils/resolver' | '//form/select' | '//form/sub' | '//table' | '//form/tree' | '//utils/type' | '//form/upload' | '//utils'
      views: 'default'
    }
