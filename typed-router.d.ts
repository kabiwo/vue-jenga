...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    '/': RouteRecordInfo<'/', '/', Record<never, never>, Record<never, never>, '//' | '//form/' | '//form/cascader/' | '//form/custom/' | '//form/date/' | '//form/empty/' | '//form/input/' | '//form/multi/' | '//form/repeat/' | '//form/select/' | '//form/sub/' | '//form/tree/' | '//form/upload/' | '//menu/' | '//modal/' | '//modal/form/' | '//other/fold-link/' | '//table/' | '//utils/conf/' | '//utils/confirm/' | '//utils/file/' | '//utils/generator/' | '//utils/init/' | '//utils/request/' | '//utils/resolver/' | '//utils/type/'>,
    ...
    '//form/multi/': RouteRecordInfo<'//form/multi/', '/form/multi', Record<never, never>, Record<never, never>>,
    ...
    '//other/fold-link/': RouteRecordInfo<'//other/fold-link/', '/other/fold-link', Record<never, never>, Record<never, never>>,
  ...
  export interface _RouteFileInfoMap {
    'src/views/index.vue': {
      routes: '/' | '//' | '//form/' | '//form/cascader/' | '//form/custom/' | '//form/date/' | '//form/empty/' | '//form/input/' | '//form/multi/' | '//form/repeat/' | '//form/select/' | '//form/sub/' | '//form/tree/' | '//form/upload/' | '//menu/' | '//modal/' | '//modal/form/' | '//table/' | '//other/fold-link/' | '//utils/conf/' | '//utils/confirm/' | '//utils/generator/' | '//utils/file/' | '//utils/init/' | '//utils/request/' | '//utils/type/' | '//utils/resolver/' | '//form/cascader' | '//utils/conf' | '//utils/confirm' | '//form/custom' | '//form/date' | '//form/empty' | '//utils/file' | '//other/fold-link' | '//form' | '//modal/form' | '//utils/generator' | '//utils/init' | '//form/input' | '//menu' | '//modal' | '//form/multi' | '//other' | '//form/repeat' | '//utils/request' | '//utils/resolver' | '//form/select' | '//form/sub' | '//table' | '//form/tree' | '//utils/type' | '//form/upload' | '//utils'
      views: 'default'
    }
    ...
    'src/views/index/form/multi/index.vue': {
      routes: '//form/multi/'
      views: never
    }
    ...
    'src/views/index/other/fold-link/index.vue': {
      routes: '//other/fold-link/'
      views: never
    }
