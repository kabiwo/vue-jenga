...
declare module 'vue-router/auto-routes' {
  ...
  export interface _RouteFileInfoMap {
    'src/views/index.vue': {
      routes: '/' | '//' | '//form/' | '//form/cascader/' | '//form/custom/' | '//form/input/' | '//form/date/' | '//form/empty/' | '//form/select/' | '//form/repeat/' | '//form/sub/' | '//form/tree/' | '//form/upload/' | '//modal/' | '//modal/form/' | '//menu/' | '//table/' | '//utils/conf/' | '//utils/confirm/' | '//utils/file/' | '//utils/generator/' | '//utils/request/' | '//utils/resolver/' | '//utils/init/' | '//utils/type/' | '//form/cascader' | '//utils/conf' | '//utils/confirm' | '//form/custom' | '//form/date' | '//form/empty' | '//utils/file' | '//form' | '//modal/form' | '//utils/generator' | '//utils/init' | '//form/input' | '//menu' | '//modal' | '//form/repeat' | '//utils/request' | '//utils/resolver' | '//form/select' | '//form/sub' | '//table' | '//form/tree' | '//utils/type' | '//form/upload' | '//utils'
      views: 'default'
    }
