...
declare module 'vue-router/auto-routes' {
  ...
  export interface _RouteFileInfoMap {
    'src/views/index.vue': {
      routes: '/' | '//' | '//form/' | '//form/cascader/' | '//form/custom/' | '//form/date/' | '//form/empty/' | '//form/input/' | '//form/repeat/' | '//form/sub/' | '//form/select/' | '//form/tree/' | '//form/multi/' | '//form/upload/' | '//menu/' | '//modal/' | '//modal/form/' | '//table/' | '//other/fold-link/' | '//utils/conf/' | '//utils/file/' | '//utils/generator/' | '//utils/init/' | '//utils/confirm/' | '//utils/request/' | '//utils/resolver/' | '//utils/type/' | '//form/cascader' | '//utils/conf' | '//utils/confirm' | '//form/custom' | '//form/date' | '//form/empty' | '//utils/file' | '//other/fold-link' | '//form' | '//modal/form' | '//utils/generator' | '//utils/init' | '//form/input' | '//menu' | '//modal' | '//form/multi' | '//other' | '//form/repeat' | '//utils/request' | '//utils/resolver' | '//form/select' | '//form/sub' | '//table' | '//form/tree' | '//utils/type' | '//form/upload' | '//utils'
      views: 'default'
    }
