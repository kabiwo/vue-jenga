...
declare module 'vue-router/auto-routes' {
  ...
  export interface _RouteFileInfoMap {
    'src/views/index.vue': {
      routes: '/' | '//' | '//form/' | '//form/cascader/' | '//form/custom/' | '//form/empty/' | '//form/date/' | '//form/input/' | '//form/select/' | '//form/tree/' | '//form/repeat/' | '//form/upload/' | '//form/sub/' | '//menu/' | '//modal/' | '//modal/form/' | '//table/' | '//utils/conf/' | '//utils/file/' | '//utils/confirm/' | '//utils/request/' | '//utils/generator/' | '//utils/init/' | '//utils/resolver/' | '//utils/type/' | '//form/cascader' | '//utils/conf' | '//utils/confirm' | '//form/custom' | '//form/date' | '//form/empty' | '//utils/file' | '//form' | '//modal/form' | '//utils/generator' | '//utils/init' | '//form/input' | '//menu' | '//modal' | '//form/repeat' | '//utils/request' | '//utils/resolver' | '//form/select' | '//form/sub' | '//table' | '//form/tree' | '//utils/type' | '//form/upload' | '//utils'
      views: 'default'
    }
